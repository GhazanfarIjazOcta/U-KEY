              ...
              <TableCell align="center">{operator.phone}</TableCell>
               ...
               <TableCell align="start">
                <Stack direction={"row"}  justifyContent="start">                 
                  <Switch
                    // checked={operators.status === "active"} // Determines if the status is active
                    // onChange={() =>
                    ...
                    // } // Toggle function
                    // color={
                    //   operators.status === "active" ? "success" : "error"
                    // } // Green for active, red for inactive
                    inputProps={{ "aria-label": "toggle operators status" }} // Accessibility
                  />
                 
        {/* {Object.values(operators.users)
