...
function TotalCard({ icon, title, totalNumber, activeNumber, inactiveNumber, maintenanceNumber }) {
    ...
    // Get the correct icon based on the icon prop
    ...
    return (
        <Box sx={{ background: "#FFF", }}>
            <Box sx={{ display: "flex", gap: "1.5rem", alignItems: { sm: "start", xs: "center" }, justifyContent: "space-between", marginBottom: "0rem", padding: "1rem 2rem 0.5rem 1rem", flexFlow: "wrap" }}>
                ...
                <Box sx={{ display: "flex", gap: "1rem", flexFlow: "wrap", alignItems: "center", justifyContent: "center", width: "100%" }}>
